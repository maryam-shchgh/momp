...
function [momp_out, momp_loc] = momp_v3(T, m, verbose, run_mp, plotting)
    ...
    if write_video
        v = VideoWriter(sprintf('T_%d_m_%d_initDsr_%d.avi', n_orig, m, dd));  % Name your video file
